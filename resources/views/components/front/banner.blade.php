                ...
                >
                  <div class="carousel-inner">
                    <div
                      ...
                      style="background: url('assets/images/banner13.jpg') no-repeat center !important"
                    >
                      <div class="banner_slide_content banner_content_inner">
                        <div class="col-lg-7 col-10">
                          <div class="banner_content3 overflow-hidden">
                            ...
                            <h4
                              class="staggered-animation mb-4 product-price"
                              data-animation="slideInLeft"
                              data-animation-delay="1.2s"
                            >
                              <span class="price">$45.00</span><del>$55.25</del>
                            </h4>
                            <a
                              class="btn btn-fill-out btn-radius staggered-animation text-uppercase"
                      ...
                      <div class="banner_slide_content banner_content_inner">
                        <div class="col-lg-8 col-10">
                          <div class="banner_content3 overflow-hidden">
                            ...
                            <h4
                              class="staggered-animation mb-3 mb-sm-4 product-price"
                              data-animation="slideInLeft"
                              data-animation-delay="1.2s"
                            >
                              <span class="price">$45.00</span><del>$55.25</del>
            ...
            <div class="col-lg-2 d-none d-lg-block">
              <div class="shop_banner2 el_banner1">
                <a href="#" class="hover_effect1">
                  ...
                  <div class="el_img">
                    <img
                      src="assets/images/shop_banner_img6.png"
              ...
              <div class="shop_banner2 el_banner2">
                <a href="#" class="hover_effect1">
                  ...
                  <div class="el_img">
                    <img
                      src="assets/images/shop_banner_img7.png"
